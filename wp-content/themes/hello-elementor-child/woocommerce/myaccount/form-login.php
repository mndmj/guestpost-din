...
$gpm_auth_view = isset( $_GET['gpm_auth'] ) && is_string( $_GET['gpm_auth'] ) ? sanitize_key( wp_unslash( $_GET['gpm_auth'] ) ) : 'login';
...
<div class="gpm-auth-card" id="customer_login" aria-labelledby="gpm-auth-title">
	...
	<?php if ( 'choose' === $gpm_auth_view ) : ?>
		...
		<nav class="gpm-auth-choices" aria-label="<?php esc_attr_e( 'Account access', 'guest-post-child' ); ?>">
			<a class="button"
				href="<?php echo esc_url( $gpm_login_url ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></a>
			<a class="button"
				href="<?php echo esc_url( $gpm_register_url ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></a>
		</nav>
		<p class="gpm-auth-home">
			<a
				href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Back to Home', 'guest-post-child' ); ?></a>
		</p>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
			...
			<?php if ( $gpm_registration_enabled ) : ?>
				<p class="gpm-auth-switch">
					<a
						href="<?php echo esc_url( $gpm_register_url ); ?>"><?php esc_html_e( 'Do not have an Account ?', 'guest-post-child' ); ?></a>
				</p>
			<?php endif; ?>
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				...
				<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password"
					id="reg_password" autocomplete="new-password" maxlength="4096" required aria-required="true" />
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="reg_password_confirm"><?php esc_html_e( 'Confirm password', 'guest-post-child' ); ?>&nbsp;<span
						class="required" aria-hidden="true">*</span><span
						class="screen-reader-text"><?php esc_html_e( 'Required', 'woocommerce' ); ?></span></label>
				<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password_confirm"
					id="reg_password_confirm" autocomplete="new-password" maxlength="4096" required aria-required="true" />
			</p>
			...
			<p class="gpm-auth-switch">
				<a
					href="<?php echo esc_url( $gpm_login_url ); ?>"><?php esc_html_e( 'Have an Account ?', 'guest-post-child' ); ?></a>
			</p>
